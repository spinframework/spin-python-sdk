...
from .imports import spin_mysql_mysql_3_0_0
...
from .imports import wasi_filesystem_types_0_3_0
from .imports import wasi_sockets_types_0_3_0
from .imports import wasi_cli_types_0_3_0
...
def result_option_wasi_http_types_0_3_0_fields_wasi_http_types_0_3_0_error_code_future(default: Callable[[], Result[Optional[wasi_http_types_0_3_0.Fields], wasi_http_types_0_3_0.ErrorCode]]) -> tuple[FutureWriter[Result[Optional[wasi_http_types_0_3_0.Fields], wasi_http_types_0_3_0.ErrorCode]], FutureReader[Result[Optional[wasi_http_types_0_3_0.Fields], wasi_http_types_0_3_0.ErrorCode]]]:
    raise NotImplementedError

def result_unit_wasi_http_types_0_3_0_error_code_future(default: Callable[[], Result[None, wasi_http_types_0_3_0.ErrorCode]]) -> tuple[FutureWriter[Result[None, wasi_http_types_0_3_0.ErrorCode]], FutureReader[Result[None, wasi_http_types_0_3_0.ErrorCode]]]:
    raise NotImplementedError
...
def list_spin_mysql_mysql_3_0_0_db_value_stream() -> tuple[StreamWriter[List[spin_mysql_mysql_3_0_0.DbValue]], StreamReader[List[spin_mysql_mysql_3_0_0.DbValue]]]:
    raise NotImplementedError

def result_unit_spin_mysql_mysql_3_0_0_error_future(default: Callable[[], Result[None, spin_mysql_mysql_3_0_0.Error]]) -> tuple[FutureWriter[Result[None, spin_mysql_mysql_3_0_0.Error]], FutureReader[Result[None, spin_mysql_mysql_3_0_0.Error]]]:
    raise NotImplementedError
...
def result_unit_wasi_cli_types_0_3_0_error_code_future(default: Callable[[], Result[None, wasi_cli_types_0_3_0.ErrorCode]]) -> tuple[FutureWriter[Result[None, wasi_cli_types_0_3_0.ErrorCode]], FutureReader[Result[None, wasi_cli_types_0_3_0.ErrorCode]]]:
    raise NotImplementedError

def result_unit_wasi_filesystem_types_0_3_0_error_code_future(default: Callable[[], Result[None, wasi_filesystem_types_0_3_0.ErrorCode]]) -> tuple[FutureWriter[Result[None, wasi_filesystem_types_0_3_0.ErrorCode]], FutureReader[Result[None, wasi_filesystem_types_0_3_0.ErrorCode]]]:
    raise NotImplementedError

def wasi_filesystem_types_0_3_0_directory_entry_stream() -> tuple[StreamWriter[wasi_filesystem_types_0_3_0.DirectoryEntry], StreamReader[wasi_filesystem_types_0_3_0.DirectoryEntry]]:
    raise NotImplementedError

def wasi_sockets_types_0_3_0_tcp_socket_stream() -> tuple[StreamWriter[Any], StreamReader[Any]]:
    raise NotImplementedError

def result_unit_wasi_sockets_types_0_3_0_error_code_future(default: Callable[[], Result[None, wasi_sockets_types_0_3_0.ErrorCode]]) -> tuple[FutureWriter[Result[None, wasi_sockets_types_0_3_0.ErrorCode]], FutureReader[Result[None, wasi_sockets_types_0_3_0.ErrorCode]]]:
    raise NotImplementedError
