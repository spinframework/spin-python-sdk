...
from ..imports import wasi_clocks_system_clock_0_3_0
...
class DescriptorStat:
    ...
    link_count: int
    size: int
    data_access_timestamp: Optional[wasi_clocks_system_clock_0_3_0.Instant]
    data_modification_timestamp: Optional[wasi_clocks_system_clock_0_3_0.Instant]
    status_change_timestamp: Optional[wasi_clocks_system_clock_0_3_0.Instant]
...
class NewTimestamp_Timestamp:
    value: wasi_clocks_system_clock_0_3_0.Instant
...
class Descriptor:
    ...
    async def advise(self, offset: int, length: int, advice: Advice) -> None:
        ...
        Raises: `componentize_py_types.Err(spin_sdk.wit.imports.wasi_filesystem_types_0_3_0.ErrorCode)`
        """
        raise NotImplementedError
