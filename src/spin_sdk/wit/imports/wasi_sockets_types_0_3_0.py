...
class TcpSocket:
    ...
    def create(cls, address_family: IpAddressFamily) -> Self:
        ...
        Raises: `componentize_py_types.Err(spin_sdk.wit.imports.wasi_sockets_types_0_3_0.ErrorCode)`
        """
