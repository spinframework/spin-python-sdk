...
class Fields:
    ...
    def from_list(cls, entries: List[Tuple[str, bytes]]) -> Self:
        ...
        Raises: `componentize_py_types.Err(spin_sdk.wit.imports.wasi_http_types_0_3_0.HeaderError)`
        """
        raise NotImplementedError
...
class RequestOptions:
    ...
    def set_connect_timeout(self, duration: Optional[int]) -> None:
        ...
        Raises: `componentize_py_types.Err(spin_sdk.wit.imports.wasi_http_types_0_3_0.RequestOptionsError)`
        """
        raise NotImplementedError
